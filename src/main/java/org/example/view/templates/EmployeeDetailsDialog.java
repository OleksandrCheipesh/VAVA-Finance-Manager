...
public class EmployeeDetailsDialog {
    ...
    public static void show(Stage owner, Employee employee, Consumer<Employee> onUpdate, Consumer<Employee> onDelete) {
        ...
        Label statusPill = new Label(I18n.t(employee.getStatus()).toUpperCase());
        ...
        grid.add(createDetailItem(I18n.t("NAME"), employee.getName() + " " + employee.getSurname()), 0, 0);
        grid.add(createDetailItem(I18n.t("E-MAIL"), employee.getEmail()), 1, 0);
        grid.add(createDetailItem(I18n.t("ROLE (INDUSTRY)"), employee.getPosition()), 0, 1);
        grid.add(createDetailItem(I18n.t("DEPARTMENT"), employee.getDepartment()), 1, 1);
    ...
    private static VBox createDetailItem(String labelTxt, String valueTxt) {
        ...
        Label val = new Label(valueTxt == null || valueTxt.isEmpty() ? I18n.t("N/A") : valueTxt);
